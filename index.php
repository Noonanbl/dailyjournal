...
<head>
    ...
    <title>Daily Journal by Nona</title>
    <link rel="icon" href="https://i.pinimg.com/736x/74/da/12/74da12aa4eaaff753023c388220fdaef.jpg" />
    <link
        rel="stylesheet"
...
<body>
    ...
    <nav class="navbar navbar-expand-sm bg-body-tertiary sticky-top">
        <div class="container">
            <a class="navbar-brand" href="#">Welcome Precious Peoples</a>
            <button
    ...
    <section id="hero" class="text-center p-5 bg-danger-subtle text-sm-start">
        <div class="container">
            <div class="d-sm-flex flex-sm-row-reverse align-items-center">
                <img src="https://i.pinimg.com/736x/45/28/df/4528dfa830e62914895cd8596bc99ea2.jpg" class="img-fluid" width="300">
                <div>
                    <h1 class="fw-bold display-4">
                        Be Shine, This Your World Not Them, Enjoy Your Life
                    </h1>
                    <h4 class="lead display-6">
                        I'm Not Mad to You, I'm Just Lose My Interesting to You, Delete Negative People!
                    </h4>
                    <h6>
            ...
            <div id="carouselExample" class="carousel slide">
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img src="img/aurora in alaska.jpg" class="d-block w-100" alt="Aurora In Alaska" width="50px" height="800px">
                    </div>
                    <div class="carousel-item">
                        <img src="img/aurora_2.gif" class="d-block w-100" alt="Aurora Borealis" width="50px" height="800px">
                    </div>
                    <div class="carousel-item">
                        <img src="img/aurora3.jpg" class="d-block w-100" alt="Aurora Montana" width="50px" height="800px">
                    </div>
                    <div class="carousel-item">
                        <img src="img/aurora4.jpg" class="d-block w-100" alt="Aurora Australis" width="50px" height="100%">
                    </div>
                    <div class="carousel-item">
                        <img src="img/aurora5.jpg" class="d-block w-100" alt="Aurora Borealis Green width=" 50px" height="800px">
                    </div>
                    <button
    ...
    <section id="aboutme" class="text-center p-5 bg-danger-subtle">
        <div class="container">
            <div class="d-sm-flex align-items-center justify-content-center">
                <div class="p-3">
                    <img id="profile-image" src="https://i.pinimg.com/736x/b7/d2/2b/b7d22b33d27c73e8ce921d947f1a6570.jpg" alt="Profile Photo" class="rounded-circle img-fluid mb-4" style="width: 200px; height: 200px; object-fit: cover;">
                </div>
                <div class="p-md-5 text-sm-start">
                    <h3 class="lead">A11.2023.15147</h3>
                    <h1 class="fw-bold">Nona Nabila Fatika</h1>
